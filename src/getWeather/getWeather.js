// (白天)转晴天气图标
import weather_sunny from "@/assets/weather/weather_sunny.png"
import weather_cloudy from "@/assets/weather/weather_cloudy.png"
import weather_shower from "@/assets/weather/weather_shower.png"
import weather_thunder_rain from "@/assets/weather/weather_thunder_rain.png"
import weather_ray_electricity_rain from "@/assets/weather/weather_ray_electricity_rain.png"
import weather_thundershower_hail from "@/assets/weather/weather_thundershower_hail.png"
// (晚上)转晴天气图标
...
function getWeather(weather) {
  var lastweatherUrl = '';
  if (weather === '晴') {
    lastweatherUrl = weather_sunny;
  } else if (weather === "阴转晴" || weather === "多云转晴" || weather === "晴转多云") {
    lastweatherUrl = weather_cloudy;
  } else if (weather === "小雨转晴") {
    lastweatherUrl = weather_shower;
  } else if (weather === "雷阵雨转晴") {
    lastweatherUrl = weather_thunder_rain;
  } else if (weather === "雷电转晴") {
    lastweatherUrl = weather_ray_electricity_rain;
  } else if (weather === "雷阵雨伴有冰雹转晴") {
    lastweatherUrl = weather_thundershower_hail;
  } else if (weather === "阴" || weather === "多云") {
    lastweatherUrl = weather_overcast;
  } else if (weather === "闪电") {
    lastweatherUrl = weather_ray_electricity;
  } else if (weather === "雷阵雨") {
    lastweatherUrl = weather_thundershower;
  } else if (weather === "小雨") {
    lastweatherUrl = weather_rain_light;
  } else if (weather === "中雨") {
    lastweatherUrl = weather_rain;
  } else if (weather === "大雨") {
    lastweatherUrl = weather_rain_heavy;
  } else if (weather === "暴雨") {
    lastweatherUrl = weather_rainstorm;
  } else if (weather === "大暴雨") {
    lastweatherUrl = weather_rainstorm_heavy;
  } else if (weather === "特大暴雨") {
    lastweatherUrl = weather_rainstorm_extraHeavy;
  } else if (weather === "冰雹") {
    lastweatherUrl = weather_hail;
  } else if (weather === "冰针") {
    lastweatherUrl = weather_ice_needle;
  } else if (weather === "雨夹雪") {
    lastweatherUrl = weather_sleet;
  } else if (weather === "小雪") {
    lastweatherUrl = weather_snow_light;
  } else if (weather === "中雪") {
    lastweatherUrl = weather_snow;
  } else if (weather === "大雪") {
    lastweatherUrl = weather_snow_heavy;
  } else if (weather === "暴风雪") {
    lastweatherUrl = weather_snowstorm;
  } else if (weather === "积雪") {
    lastweatherUrl = weather_snows;
  } else if (weather === "霜冻") {
    lastweatherUrl = weather_frost;
  } else if (weather === "结冰") {
    lastweatherUrl = weather_freeze;
  } else if (weather === "风") {
    lastweatherUrl = weather_wind;
  } else if (weather === "龙卷风") {
    lastweatherUrl = weather_tornado;
  } else if (weather === "台风") {
    lastweatherUrl = weather_typhoon;
  } else if (weather === "飑") {
    lastweatherUrl = weather_squall;
  } else if (weather === "尘卷风") {
    lastweatherUrl = weather_dust_devil;
  } else if (weather === "浮尘") {
    lastweatherUrl = weather_floating_dust;
  } else if (weather === "霾") {
    lastweatherUrl = weather_fhaze;
  } else if (weather === "扬沙") {
    lastweatherUrl = weather_blowing_sand;
  } else if (weather === "强沙尘暴") {
    lastweatherUrl = weather_sand_storm_heavy;
  } else if (weather === "雾") {
    lastweatherUrl = weather_fog;
  } else if (weather === "极光") {
    lastweatherUrl = weather_aurora;
  }

  return lastweatherUrl;
}
